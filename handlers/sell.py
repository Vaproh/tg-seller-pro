...
from core.keyboards import (
    sell_accounts_keyboard, sale_status_keyboard, sales_filter_keyboard,
...
async def sell_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not seller:
        await update.message.reply_text("You are not registered as a seller.")
        return
...
async def sale_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Invalid sale ID.")
        return
...
async def voidsale_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"Void sale #{sale_id}? Account will return to stock.",
